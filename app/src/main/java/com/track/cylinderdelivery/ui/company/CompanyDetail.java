...
public class CompanyDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPinNumber.setText(mapdata.get("taxNumber"));
        ...
        txtPhoneNo.setText(mapdata.get("phone")+secondaryPhone);
        ...
        txtEmail.setText(mapdata.get("email")+secondaryEmail);
    ...
    private void callChangeCompanyStatus() {
        {
            ...
            progressDialog.show();
            String url = "http://test.hdvivah.in/Api/MobCompany/ChangeCompanyStatus?Id="+mapdata.get("companyId")+"&Status="+Status+"&UserId="+settings.getString("userId","1");
            Log.d("request==>",url);
