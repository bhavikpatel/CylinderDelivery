...
public class AcknowledgeListAdapter extends RecyclerView.Adapter<AcknowledgeListAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.companyName.setText(listData.get(position).get("companyName"));
        holder.tvRemark.setText(listData.get(position).get("remark"));
        holder.tvStatus.setText(listData.get(position).get("status"));
        String createdBy="Created by: "+listData.get(position).get("createdByName");
        holder.tvCreatedby.setText(createdBy);
        String CreatedDate="Created Date: "+listData.get(position).get("createdDateStr");
