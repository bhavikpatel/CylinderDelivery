...
public class CylinderScanedListAdapter extends RecyclerView.Adapter<CylinderScanedListAdapter.ViewHolder>{
    ...
    CylinderScanListActivity context;
    public CylinderScanedListAdapter(ArrayList<String> dataList, CylinderScanListActivity activity) {
        qrcodeList=dataList;
        context=activity;
    }
